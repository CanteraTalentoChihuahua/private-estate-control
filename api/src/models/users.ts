export default {
    ...
    createNewUser: `INSERT INTO T_Users (IdResDev, FirstName, LastName, PhoneNumber, Email, Password, Active, FacialID) 
    VALUES (@idResDev, @firstName, @lastName, @phoneNumber, @email, @password, @active, @facialId)`,
