export default {
    ...
    T_Houses.Address, T_Houses.Balance, T_Houses.Occuppied, T_Houses.IdResDev, T_UsersHouses.IdUserHouse
    FROM T_Users
    JOIN T_UsersHouses
    ...
    reportHousesUsers: `SELECT T_Houses.IdHouse, T_Houses.Address, T_Houses.Balance, T_Houses.Occuppied, T_Houses.IdResDev, T_UsersHouses.IdUserHouse,
    T_Users.FirstName, T_Users.LastName, T_Users.Email, T_Users.Active, T_Users.FaceID
    FROM T_Users 
    JOIN T_UsersHouses 
    ON T_UsersHouses.IdUser = T_Users.IdUser
    JOIN T_Houses
